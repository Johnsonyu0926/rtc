...
/*	yang_create_YangExtmapVector(&audio_media_desc->extmaps);
	...
	yang_strncpy(audio_media_desc->extmaps.payload[0].extmap,Yang_SDP_kTWCCExt);*/
#endif
	...
	yang_strncpy(audiotype->format_specific_param,
	...
	//yang_strncpy(videotype->encoding_name, "red");
